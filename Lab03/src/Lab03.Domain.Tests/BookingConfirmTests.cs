...
namespace Lab03.Domain.Confirm.Tests
{
    public class BookingServiceTests
    {
        ...
        public void Booking_should_take_one_payment_with_amount_50_and_another_with_amount_65()
        {
           ...
           // assert
           A.CallTo(() => paymentGateway.CapturePayment(65, A<decimal>.Ignored)).MustHaveHappenedOnceExactly();
           A.CallTo(() => paymentGateway.CapturePayment(50, A<decimal>.Ignored)).MustHaveHappenedOnceExactly();
        }
        ...
        public void Booking_confirm_should_use_the_amount_suggested_by_the_price_calculator()
        {
           ...
           // assert
           A.CallTo(() => paymentGateway.CapturePayment(amount, vatAmount)).MustHaveHappenedOnceExactly();
        }
        ...
        public void Booking_confirm_should_take_two_different_payments_suggested_by_the_price_calculator_in_the_correct_order()
        {
            ...
            // assert
            A.CallTo(() => paymentGateway.CapturePayment(price1.Amount, price1.VatAmount)).MustHaveHappenedOnceExactly().Then(
            A.CallTo(() => paymentGateway.CapturePayment(price2.Amount, price2.VatAmount)).MustHaveHappenedOnceExactly());
        }
    }
}
